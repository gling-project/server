...
DB_CONNECTION="heroku pg:psql --app gling-prod DATABASE"
...
curl -H "Content-Type: application/json" -X POST -d  '{"email":"florian.jeanmart@gmail.com","password":"password"}' https://gling-prod.herokuapp.com/rest/import_demo
