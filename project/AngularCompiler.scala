...
//    def compile(): String = {
//
//        val coffeeRoots: PathSet[Path] = "public" / "javascripts" ** "*.coffee"
//        val jadeRoots: PathSet[Path] = "public" / "javascripts" ** "*.jade"
//
//        List(coffeeRoots, jadeRoots).foreach { v =>
//            compileFiles(v, Path.fromString("target/scala-2.10/resource_managed"))
//        }
//
//
