...
angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put("/assets/javascripts/view/admin/adminStat.html",
    "<div>Stats</div><table class=admin_stat><tr ng-repeat=\"(title, value) in stats\"><td>{{title}}</td><td>{{value}}</td></tr></table>");
  $templateCache.put("/assets/javascripts/view/admin/welcome.html",
    "<div><button ng-click=\"navigateTo('/admin/business')\">Business list</button> <button ng-click=\"navigateTo('/admin/categories_and_interests')\">Catégories et intérêts</button> <button ng-click=\"navigateTo('/admin/stat')\">Statistiques</button></div>");
