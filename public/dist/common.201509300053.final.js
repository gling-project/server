...
angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put("/assets/javascripts/directive/mobile/galleryMobile/template.html",
    "<div class=gallery-modal-mobile ng-show=display><div ng-click=close()><div class=previous ng-click=previous() ng-show=\"images.length>1\"><div><span class=gling-icon-arrow_left></span></div></div><button ng-click=close() class=\"glyphicon glyphicon-remove\"></button> <img class=gallery-picture ng-src=\"{{image | image}}\"><div class=description ng-show=\"image.comment!=null\">{{image.comment}}</div><div class=next ng-click=next() ng-show=\"images.length>1\"><div><span class=gling-icon-arrow_right></span></div></div></div></div>");
  $templateCache.put("/assets/javascripts/directive/mobile/headerSearch/template.html",
    "<div class=\"navbar navbar-app navbar-absolute-top\" ng-class=\"{'header-with-advanced-search':advancedSearch}\"><div class=\"navbar-brand navbar-brand-center header-option-container\" style=\"padding-top: 5px\"><search-bar-ctrl ng-info={mobile:true}></search-bar-ctrl></div><div class=\"btn-group pull-left\"><div class=\"btn btn-navbar\" ng-click=back() ng-hide=\"displayMenu !== false\"><div class=nav-button ng-show=displayBack()><i class=\"glyphicon glyphicon-chevron-left\"></i></div></div><div class=\"btn btn-navbar nav-menu\" ng-click=displayMenu() ng-show=\"displayMenu !== false\"><div class=nav-button><i class=\"fa fa-bars\"></i></div></div></div></div>");
