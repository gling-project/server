...
myApp.service("facebookService", ['$http', 'accountService', '$locale', 'languageService', '$FB', 'constantService', '$location', '$flash', function ($http, accountService, $locale, languageService,$FB,constantService,$location,$flash) {
...
angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put("/assets/javascripts/directive/component/publicationListMobile/template.html",
    "<div class=publication-list-mobile><div ng-show=\"getInfo().loading===true\" class=loading><img src=\"/assets/images/big_loading.gif\"></div><div ng-show=\"getInfo().loading!=true && publications.length == 0\">{{'--.list.nothing' | translateText}}</div><div ng-hide=\"getInfo().loading===true\" ng-repeat=\"publication in publications\" class=\"publication-box publication-publication\" ng-click=click()><div class=publication-header ng-click=\"navigateTo('/business/'+publication.businessId)\"><img class=illustration ng-src=\"{{publication.businessIllustration | image}}\"><div class=title><span>{{publication.businessName}}</span></div><div class=distance><i class=\"gling-icon gling-icon-earth\"></i> {{publication.distance / 1000 | number:2}} km</div></div><div class=publication-title><i ng-show=\"getInterestClass(publication)!=null\" class=\"publication-interest gling-icon {{getInterestClass(publication)}}\"></i><div class=publication-badge ng-show=\"publication.type === 'PROMOTION'\">- {{publication.offPercent * 100 | number:0}}%</div>{{publication.title}}</div><div class=publication-body><div class=publication-data ng-class=\"{'publication-body-two':publication.pictures.length>0}\" ng-hide=\"descriptionIsEmpty(publication) === true\"><div ng-show=\"publication.type === 'PROMOTION'\" ng-class=\"{'publication-bordered-bottom' : publication.description !=null && publication.description.length > 0}\" class=publication-data-header><i class=\"gling-icon gling-icon-calendar\"></i><div>{{'--.publication.promotionTo' | translateText}}</div><div>&lt; {{publication.endDate | date:'dd MMM HH:mm'}}</div></div><div class=publication-data-body ng-show=\"publication.description !=null && publication.description.length > 0\" ng-bind-html=\"publication.description | text\"></div></div><div class=publication-gallery ng-class=\"{'publication-body-two':descriptionIsEmpty(publication) !== true,'publication-body-two-right':descriptionIsEmpty(publication) !== true}\" ng-show=\"publication.pictures.length > 0 \" ng-click=openGallery(publication.pictures[0],publication)><div class=publication-gallery-image-box><img ng-src=\"{{publication.pictures[0] | image}}\" class=publication-illustration><div ng-show=\"publication.pictures.length > 1\" class=publication-illustration-plus-icon><span>+{{publication.pictures.length - 1}}</span></div></div></div></div><div class=publication-footer><div class=\"publication-footer-date publication-bordered-bottom\">{{'--.publication.publishTo' | translateText}} {{publication.startDate | date:'dd MMM yyyy'}}</div><div class=publication-footer-facebook><facebook-share-publication-ctrl ng-info={businessId:publication.businessId,publicationId:publication.id}></facebook-share-publication-ctrl></div></div></div></div>");
  $templateCache.put("/assets/javascripts/directive/component/publicationListMobileForBusiness/template.html",
    "<div class=publication-list-mobile><div ng-show=\"getInfo().loading===true\" class=loading><img src=\"/assets/images/big_loading.gif\"></div><div ng-show=\"getInfo().loading!=true && publications.length == 0\">{{'--.list.nothing' | translateText}}</div><div ng-hide=\"getInfo().loading===true\" ng-repeat=\"publication in publications\" class=\"publication-box publication-publication\" ng-click=click()><div class=publication-title><i ng-show=\"getInterestClass(publication)!=null\" class=\"publication-interest gling-icon {{getInterestClass(publication)}}\"></i> {{publication.title}}</div><div class=publication-badge ng-show=\"publication.type === 'PROMOTION'\">- {{publication.offPercent * 100 | number:0}}%</div><div class=publication-body><div class=publication-data ng-class=\"{'publication-body-two':publication.pictures.length>0}\" ng-hide=\"descriptionIsEmpty(publication) === true\"><div ng-show=\"publication.type === 'PROMOTION'\" ng-class=\"{'publication-bordered-bottom' : publication.description !=null && publication.description.length > 0}\" class=publication-data-header><i class=\"gling-icon gling-icon-calendar\"></i><div>{{'--.publication.promotionTo' | translateText}}</div><div>&lt; {{publication.endDate | date:'dd MMM HH:mm'}}</div></div><div class=publication-data-body ng-show=\"publication.description !=null && publication.description.length > 0\" ng-bind-html=\"publication.description | text\"></div></div><div class=publication-gallery ng-class=\"{'publication-body-two':descriptionIsEmpty(publication) !== true,'publication-body-two-right':descriptionIsEmpty(publication) !== true}\" ng-show=\"publication.pictures.length > 0 \" ng-click=openGallery(publication.pictures[0],publication)><div class=publication-gallery-image-box><img ng-src=\"{{publication.pictures[0] | image}}\" class=publication-illustration><div ng-show=\"publication.pictures.length > 1\" class=publication-illustration-plus-icon><span>+{{publication.pictures.length - 1}}</span></div></div></div></div><div class=publication-footer><div class=\"publication-footer-date publication-bordered-bottom\">{{'--.publication.publishTo' | translateText}} {{publication.startDate | date:'dd MMM yyyy'}}</div><div class=publication-footer-facebook><facebook-share-publication-ctrl ng-info={businessId:publication.businessId,publicationId:publication.id}></facebook-share-publication-ctrl></div></div></div></div>");
  ...
  $templateCache.put("/assets/javascripts/directive/town/townBusiness/template.html",
    "<div><div class=town-business-list ng-show=\"elementToDisplay === 'list'\"><h3>Les commerces de votre commune.</h3><div class=search-box><div class=input-group><span class=\"input-group-addon glyphicon glyphicon-search\" id=basic-addon1></span> <input class=form-control placeholder=\"Par nom, adresse, type,...\" aria-describedby=basic-addon1></div><button class=\"btn gling-button-dark\">Ok</button></div>Cliquer sur les images pour obtenir plus d'information<br><div><div class=town-business-list-element ng-repeat=\"business in businesses\" ng-click=selectBusiness(business)><img ng-src=\"{{business.illustration | image}}\"><div class=town-business-list-element-data><div class=business-name>{{business.name}}</div><div class=address>{{business.address.street}}</div></div></div></div></div><div ng-show=\"elementToDisplay === 'businessDetails'\"><div><button ng-click=backToList() class=\"btn gling-button-dark glyphicon glyphicon-chevron-left\">Retourner à la liste des commerces</button></div><div class=town-business-details><div class=town-business-details-left><div class=town-business-details-header><img ng-src=\"{{selectedBusiness.illustration | image}}\"><div><div class=business-header-name>{{selectedBusiness.name}}</div><div class=business-header-details>{{selectedBusiness.address.street}}<br>{{selectedBusiness.phone}}<br><a href=mailto:{{selectedBusiness.email}}>{{selectedBusiness.email}}</a></div></div></div><div class=business-description>{{selectedBusiness.description}}</div></div><div class=town-business-details-right><schedule-ctrl ng-info={dto:selectedBusiness.schedules}></schedule-ctrl><publication-list-for-town-ctrl ng-info={businessId:selectedBusiness.id}></publication-list-for-town-ctrl></div></div></div></div>");
  ...
  $templateCache.put("/assets/javascripts/view/mobile/business.html",
    "<div class=\"navbar navbar-app navbar-absolute-top\" ng-class=\"{'header-with-advanced-search':advancedSearch}\"><div class=\"btn-group pull-left\"><div class=\"btn btn-navbar\" ng-click=back()><div class=nav-button><i class=\"glyphicon glyphicon-chevron-left\"></i></div></div></div><div class=\"btn-group pull-right\"><div class=\"btn btn-navbar\" ng-click=followed()><div class=\"nav-button business-page-follow\"><span class=selected ng-show=business.following>{{'--.followWidget.stopFollow' | translateText}}<i class=\"gling-icon gling-icon-bell\"></i></span> <span ng-hide=business.following>{{'--.followWidget.follow' | translateText}}<i class=\"gling-icon gling-icon-bell2\"></i></span></div></div></div></div><div class=app-body><div class=app-content><div class=body-mask ng-show=displayMask></div><div class=scrollable><div class=\"scrollable-content business-mobile-page scrollable-content-body\"><div class=scrollable-content-inner><div class=business-page-header ng-style=\"{'background-image':'url('+(business.landscape | image)+')' }\"><div class=\"edit-button-container landscape-edit\"><button class=\"btn gling-button-dark btn-xs glyphicon glyphicon-edit\" ng-show=edit ng-click=editLandscape()>{{'--.business.page.edit.landscape' | translateText}}</button></div><div class=business-page-illustration-container><img class=business-illustration ng-src=\"{{business.illustration | image}}\"><div class=edit-button-container><button class=\"btn gling-button-dark btn-xs glyphicon glyphicon-edit btn-sm\" ng-show=edit ng-click=editIllustration()>{{'--.business.page.edit.illustration' | translateText}}</button></div></div><div class=business-page-name>{{business.name}}<div class=edit-button-container><button class=\"btn gling-button-dark btn-xs glyphicon glyphicon-edit\" ng-show=\"edit && business.businessStatus === 'NOT_PUBLISHED'\" ng-click=editbusiness()>{{'--.business.page.edit.business' | translateText}}</button></div></div></div><div style=\"overflow: auto\"><div class=business-tab-set ng-style=\"{width:(actions.length * 55 + 14) + 'px'}\"><div class=business-tab style=display:inline-block ng-class=\"{'selected':interfaceToDisplay === action.name}\" ng-repeat=\"action in actions\" ng-show=action.display() ng-click=action.action()><i class=\"gling-icon {{action.icon}}\"></i> {{action.name}}</div></div></div><div ng-show=\"interfaceToDisplay=='home'\"><publication-list-mobile-for-business-ctrl ng-info=publicationListParam></publication-list-mobile-for-business-ctrl></div><div class=section ng-show=\"interfaceToDisplay=='info'\"><table class=business-info-line><tr><td colspan=2><div class=business-info-line-action><google-map-widget-ctrl ng-info=googleMapParams></google-map-widget-ctrl></div></td></tr><tr><td><div class=business-address>{{business.address.street}}<br>{{business.address.zip}}<br>{{business.address.city}}</div></td><td class=td-action>{{business.distance / 1000 | number:2}} Km</td></tr></table><table class=business-info-line ng-show=\"business.phone!=null\"><tr><td>{{business.phone}}</td><td class=td-action><a class=\"business-info-line-action glyphicon glyphicon-earphone\" href=tel:{{business.phone}}></a></td></tr></table><table class=business-info-line ng-show=\"business.website!=null\"><tr><td>{{'--.generic.site' | translateText}}</td><td class=td-action><a href={{business.website}} target=_blank>{{business.website}}</a></td></tr></table><table class=business-info-line ng-show=\"business.email!=null\"><tr><td>{{business.email}}</td><td class=td-action><a class=\"business-info-line-action glyphicon glyphicon-envelope\" href=mailto:{{business.email}}></a></td></tr></table><table class=business-info-line ng-show=\"displaySchedule() === true\"><tr><td><schedule-ctrl ng-info={dto:business.schedules}></schedule-ctrl></td></tr></table></div><div class=\"section gallery-mobile\" ng-show=\"interfaceToDisplay=='gallery'\"><h4>{{'--.generic.gallery' | translateText}}</h4><img ng-repeat=\"image in business.galleryPictures\" style=\"margin-top: 5px\" ng-click=openGallery(image) ng-src=\"{{image | image}}\"></div></div></div></div></div></div>");
  ...
  $templateCache.put("/assets/javascripts/view/mobile/followed_business_page.html",
    "<header-search-ctrl></header-search-ctrl><div class=app-body><div class=\"app-content modal-login\"><div class=scrollable><div class=\"section customer-registration scrollable-content followed-business\">{{'--.followed-business.page.title' | translateText}}<div ng-repeat=\"business in businesses\" class=followed-business-line><div><img class=illustration ng-click=\"navigateTo('/business/'+business.id)\" ng-src=\"{{business.illustration | image}}\"> {{business.name}} {{business.followingFrom | date}}</div><div><button class=\"btn btn-xs gling-button-dark\" ng-click=stopFollow(business)>{{'--.business.follow.stopFollowing' | translateText}}</button> <button class=\"btn btn-xs gling-button-dark\" ng-click=setNotification(business)><input type=checkbox ng-model=business.followingNotification> Notifications</button></div></div></div></div></div></div>");
