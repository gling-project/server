...
angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put("/assets/javascripts/directive/form/login/template.html",
    "<div class=\"form login-form\"><div class=facebook-login-btn-container><a href=\"https://www.facebook.com/dialog/oauth/?client_id={{facebookAppId}}&redirect_uri={{basic_url}}/&state=BELGIUM&scope={{facebookAuthorization}}&response_type=token\" ng-show=getInfo().mobileVersion class=\"facebook-login-btn btn btn-primary\"><img src=\"/assets/images/facebook/login_icon.png\"> <span>{{'--.loginModal.facebook.btn' |translateText}}</span></a> <button ng-click=fb_login(); class=\"facebook-login-btn btn btn-primary\" ng-hide=getInfo().mobileVersion><img src=\"/assets/images/facebook/login_icon.png\"> <span>{{'--.loginModal.facebook.btn' |translateText}}</span></button></div><table class=horizontal-split><tr><td><div></div></td><td>{{'--.generic.or' | translateText}}</td><td><div></div></td></tr></table><dir-field-text ng-info=fields.email></dir-field-text><dir-field-text ng-info=fields.password></dir-field-text><dir-field-check ng-info=fields.keepSessionOpen></dir-field-check></div>");
