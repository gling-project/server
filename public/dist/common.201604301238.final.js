...
myApp.directive('promotionFormCtrl', ['$flash', 'directiveService', '$timeout', 'businessService', 'accountService', 'constantService', '$compile', function ($flash, directiveService, $timeout, businessService, accountService, constantService,$compile) {
...
;
myApp.directive('businessNotificationFormCtrl', ['$flash', 'directiveService', 'businessService', 'accountService', 'constantService', '$compile', function ($flash, directiveService, businessService, accountService,constantService,$compile) {
