...
l.push(k);return l}.call(this),delete this.spiderfying,this.spiderfied=!0,this.trigger("spiderfy",o,b))},l.unspiderfy=function(a){var b,d,e,f,g,h,i;if(null==a&&(a=null),null==this.spiderfied)return this;for(this.unspiderfying=!0,i=[],g=[],h=this.markers,b=0,d=h.length;d>b;b++)f=h[b],null!=f._omsData?(f._omsData.leg.setMap(null),f!==a&&f.setPosition(f._omsData.usualPosition),f.setZIndex(null),e=f._omsData.hightlightListeners,null!=e&&(c.removeListener(e.highlight),c.removeListener(e.unhighlight)),delete f._omsData,i.push(f)):g.push(f);return delete this.unspiderfying,delete this.spiderfied,this.trigger("unspiderfy",i,g),this},l.ptDistanceSq=function(a,b){var c,d;return c=a.x-b.x,d=a.y-b.y,c*c+d*d},l.ptAverage=function(a){var b,c,d,e,g,h;for(g=h=0,b=0,c=a.length;c>b;b++)e=a[b],g+=e.x,h+=e.y;return d=a.length,new f.Point(g/d,h/d)},l.llToPt=function(a){return this.projHelper.getProjection().fromLatLngToDivPixel(a)},l.ptToLl=function(a){return this.projHelper.getProjection().fromDivPixelToLatLng(a)},l.minExtract=function(a,b){var c,d,e,f,g,h,i;for(e=g=0,h=a.length;h>g;e=++g)f=a[e],i=b(f),("undefined"==typeof c||null===c||d>i)&&(d=i,c=e);return a.splice(c,1)[0]},l.arrIndexOf=function(a,b){var c,d,e,f;if(null!=a.indexOf)return a.indexOf(b);for(c=d=0,e=a.length;e>d;c=++d)if(f=a[c],f===b)return c;return-1},b}(),b.then(function(){c.OverlappingMarkerSpiderfier.initializeGoogleMaps(a.google)}),this.OverlappingMarkerSpiderfier}]),b.module("uiGmapgoogle-maps.extensions").service("uiGmapExtendMarkerClusterer",["uiGmapLodash","uiGmapPropMap",function(b,c){return{init:_.once(function(){(function(){var d={}.hasOwnProperty,e=function(a,b){function c(){this.constructor=a}for(var e in b)d.call(b,e)&&(a[e]=b[e]);return c.prototype=b.prototype,a.prototype=new c,a.__super__=b.prototype,a};a.NgMapCluster=function(a){function d(a){d.__super__.constructor.call(this,a),this.markers_=new c}return e(d,a),d.prototype.addMarker=function(a){var b,c;if(this.isMarkerAlreadyAdded_(a)){var d=this.markers_.get(a.key);if(d.getPosition().lat()==a.getPosition().lat()&&d.getPosition().lon()==a.getPosition().lon())return!1}if(this.center_){if(this.averageCenter_){var e=this.markers_.length+1,f=(this.center_.lat()*(e-1)+a.getPosition().lat())/e,g=(this.center_.lng()*(e-1)+a.getPosition().lng())/e;this.center_=new google.maps.LatLng(f,g),this.calculateBounds_()}}else this.center_=a.getPosition(),this.calculateBounds_();return a.isAdded=!0,this.markers_.push(a),b=this.markers_.length,c=this.markerClusterer_.getMaxZoom(),null!==c&&this.map_.getZoom()>c?a.getMap()!==this.map_&&a.setMap(this.map_):b<this.minClusterSize_?a.getMap()!==this.map_&&a.setMap(this.map_):b===this.minClusterSize_?this.markers_.each(function(a){a.setMap(null)}):a.setMap(null),!0},d.prototype.isMarkerAlreadyAdded_=function(a){return b.isNullOrUndefined(this.markers_.get(a.key))},d.prototype.getBounds=function(){var a=new google.maps.LatLngBounds(this.center_,this.center_);return this.getMarkers().each(function(b){a.extend(b.getPosition())}),a},d.prototype.remove=function(){this.clusterIcon_.setMap(null),this.markers_=new c,delete this.markers_},d}(Cluster),a.NgMapMarkerClusterer=function(a){function b(a,d,e){b.__super__.constructor.call(this,a,d,e),this.markers_=new c}return e(b,a),b.prototype.clearMarkers=function(){this.resetViewport_(!0),this.markers_=new c},b.prototype.removeMarker_=function(a){return this.markers_.get(a.key)?(a.setMap(null),this.markers_.remove(a.key),!0):!1},b.prototype.createClusters_=function(a){var b,c,d,e=this;if(this.ready_){0===a&&(google.maps.event.trigger(this,"clusteringbegin",this),"undefined"!=typeof this.timerRefStatic&&(clearTimeout(this.timerRefStatic),delete this.timerRefStatic)),d=this.getMap().getZoom()>3?new google.maps.LatLngBounds(this.getMap().getBounds().getSouthWest(),this.getMap().getBounds().getNorthEast()):new google.maps.LatLngBounds(new google.maps.LatLng(85.02070771743472,-178.48388434375),new google.maps.LatLng(-85.08136444384544,178.00048865625));var f=this.getExtendedBounds(d),g=Math.min(a+this.batchSize_,this.markers_.length),h=this.markers_.values();for(b=a;g>b;b++)c=h[b],!c.isAdded&&this.isMarkerInBounds_(c,f)&&(!this.ignoreHidden_||this.ignoreHidden_&&c.getVisible())&&this.addToClosestCluster_(c);if(g<this.markers_.length)this.timerRefStatic=setTimeout(function(){e.createClusters_(g)},0);else{for(b=0;b<this.clusters_.length;b++)this.clusters_[b].updateIcon_();delete this.timerRefStatic,google.maps.event.trigger(this,"clusteringend",this)}}},b.prototype.addToClosestCluster_=function(a){var b,c,d,e,f=4e4,g=null;for(b=0;b<this.clusters_.length;b++)d=this.clusters_[b],e=d.getCenter(),e&&(c=this.distanceBetweenPoints_(e,a.getPosition()),f>c&&(f=c,g=d));g&&g.isMarkerInClusterBounds(a)?g.addMarker(a):(d=new NgMapCluster(this),d.addMarker(a),this.clusters_.push(d))},b.prototype.redraw_=function(){this.createClusters_(0)},b.prototype.resetViewport_=function(a){var b;for(b=0;b<this.clusters_.length;b++)this.clusters_[b].remove();this.clusters_=[],this.markers_.each(function(b){b.isAdded=!1,a&&b.setMap(null)})},b.prototype.extend=function(a,b){return function(a){var b;for(b in a.prototype)"constructor"!==b&&(this.prototype[b]=a.prototype[b]);return this}.apply(a,[b])},ClusterIcon.prototype.show=function(){if(this.div_){var a="",b=this.backgroundPosition_.split(" "),c=parseInt(b[0].trim(),10),d=parseInt(b[1].trim(),10),e=this.getPosFromLatLng_(this.center_);this.div_.style.cssText=this.createCss(e),a="<img src='"+this.url_+"' style='position: absolute; top: "+d+"px; left: "+c+"px; ",a+=this.cluster_.getMarkerClusterer().enableRetinaIcons_?"width: "+this.width_+"px;height: "+this.height_+"px;":"clip: rect("+-1*d+"px, "+(-1*c+this.width_)+"px, "+(-1*d+this.height_)+"px, "+-1*c+"px);",a+="'>",this.div_.innerHTML=a+"<div style='position: absolute;top: "+this.anchorText_[0]+"px;left: "+this.anchorText_[1]+"px;color: "+this.textColor_+";font-size: "+this.textSize_+"px;font-family: "+this.fontFamily_+";font-weight: "+this.fontWeight_+";font-style: "+this.fontStyle_+";text-decoration: "+this.textDecoration_+";text-align: center;width: "+this.width_+"px;line-height:"+this.height_+"px;'>"+this.sums_.text+"</div>","undefined"==typeof this.sums_.title||""===this.sums_.title?this.div_.title=this.cluster_.getMarkerClusterer().getTitle():this.div_.title=this.sums_.title,this.div_.style.display=""}this.visible_=!0},b}(MarkerClusterer)}).call(this)})}}])}(window,angular);var test=function(a){var b=a.getMyself();return null==b?"NOT_CONNECTED":b.type},initializeCommonRoutes=function(){myApp.config(["$routeProvider","$locationProvider",function(a,b){a.when("/",{templateUrl:"/assets/javascripts/view/web/home.html",controller:"HomeCtrl",resolve:{a:["accountService","$rootScope",function(a,b){b.$broadcast("PROGRESS_BAR_START");test(a)}]}}).when("/profile",{templateUrl:"/assets/javascripts/view/web/profile.html",controller:"ProfileCtrl",resolve:{a:["accountService","$location","$rootScope",function(a,b,c){c.$broadcast("PROGRESS_BAR_START"),"NOT_CONNECTED"==test(a)&&b.path("/")}]}}).when("/search/:param?",{templateUrl:"/assets/javascripts/view/web/search_page.html",controller:"SearchPageCtrl",resolve:{a:["$rootScope",function(a){a.$broadcast("PROGRESS_BAR_START")}]}}).when("/my-businesses",{templateUrl:"/assets/javascripts/view/web/followed_business_page.html",controller:"FollowedBusinessPageCtrl",resolve:{a:["$rootScope",function(a){a.$broadcast("PROGRESS_BAR_START")}]}}).when("/business/:businessId",{templateUrl:"/assets/javascripts/view/web/business.html",controller:"BusinessCtrl",resolve:{a:["$rootScope",function(a){a.$broadcast("PROGRESS_BAR_START")}]}}).when("/business/:businessId/publication/:publicationId",{templateUrl:"/assets/javascripts/view/web/business.html",controller:"BusinessCtrl",resolve:{a:["$rootScope",function(a){a.$broadcast("PROGRESS_BAR_START")}]}}).when("/welcome/",{resolve:{a:["$rootScope",function(a){window.location.replace("/welcome/")}]}}).when("/legal/",{resolve:{a:["$rootScope",function(a){window.location.replace("/legal/")}]}}).when("/help/",{resolve:{a:["$rootScope",function(a){window.location.replace("/help/")}]}}).otherwise({redirectTo:"/"}),b.html5Mode(!0)}])},myApp=angular.module("app",["ngAnimate","ui.bootstrap","ui.bootstrap.datetimepicker","angucomplete","angularFileUpload","ngRoute","ngTable","geolocation","timer","uiGmapgoogle-maps","djds4rce.angular-socialshare"]);app.config(["$locationProvider",function(a){a.html5Mode({enabled:!0,requireBase:!1})}]),myApp.controller("LoginModalCtrl",["$scope","$flash","facebookService","translationService","$modal","$modalInstance","accountService","$location","modalService","fctToExecute","fctToExecuteParams","helpMessage",function(a,b,c,d,e,f,g,h,i,j,k,l){a.loading=!1,a.fctToExecute=j,a.helpMessage=l,a.loginFormParam={facebookSuccess:function(b){null!=j&&j(k),a.close()}},a.close=function(){f.close()},a.save=function(){a.loginFormParam.isValid?(a.loading=!0,g.login(a.loginFormParam.dto,function(){b.success(d.get("--.login.flash.success")),a.loading=!1,a.close(),c.logout(),"BUSINESS"==g.getMyself().type&&h.path("/business/"+g.getMyself().businessId),null!=j&&j(k)},function(){a.loading=!1})):a.loginFormParam.displayErrorMessage=!0},a.toForgotPassword=function(){i.openForgotPasswordModal(a.loginFormParam.dto.email),a.close()},a.toBusinessRegistration=function(){a.close(),i.openBusinessRegistrationModal()},a.toCustomerRegistration=function(){a.close(),i.openCustomerRegistrationModal(j,k)}}]),myApp.controller("ChangePasswordModalCtrl",["$scope","$flash","$modalInstance","accountService","$timeout",function(a,b,c,d,e){a.loading=!1,a.dto={},a.fields={oldPassword:{id:"change-password-input-password",name:"password",fieldTitle:"--.generic.oldPassword",validationRegex:"^[a-zA-Z0-9-_%]{6,18}$",validationMessage:"--.generic.validation.password",fieldType:"password",focus:function(){return!0},disabled:function(){return a.loading},field:a.dto,fieldName:"oldPassword"},newPassword:{id:"change-password-input-new-password",name:"newPassword",fieldTitle:"--.changePasswordModal.newPassword",validationRegex:"^[a-zA-Z0-9-_%]{6,18}$",validationMessage:"--.generic.validation.password",fieldType:"password",details:"--.registration.form.password.help",disabled:function(){return a.loading},field:a.dto,fieldName:"newPassword"},repeatPassword:{id:"change-password-input-repeat-password",name:"repeatNewPassword",fieldTitle:"--.generic.repeatPassword",fieldType:"password",validationMessage:"--.generic.validation.repeatPassword",validation:function(){return a.dto.newPassword===a.dto.repeatPassword},disabled:function(){return a.loading},field:a.dto,fieldName:"repeatPassword"}},a.close=function(){c.close()},a.$watch("fields",function(){var b=!0;for(var c in a.fields){var d=a.fields[c];!a.fields.hasOwnProperty(c)||null!=d.isValid&&d.isValid!==!1||(d.firstAttempt=!a.displayErrorMessage,b=!1)}a.isValid=b},!0),a.$watch("displayErrorMessage",function(){for(var b in a.fields){var c=a.fields[b];c.firstAttempt=!a.displayErrorMessage}}),a.save=function(){a.isValid&&(a.loading=!0,d.changePassword(a.dto.oldPassword,a.dto.newPassword,function(){a.loading=!1,a.close()},function(){a.loading=!1}))}}]),myApp.controller("ForgotPasswordModalCtrl",["$scope","$http","$flash","$modalInstance","$filter","email","accountService",function(a,b,c,d,e,f,g){a.loading=!1,a.dto={email:f},a.fields={email:{fieldType:"email",name:"email",fieldTitle:"--.changeEmailModal.email",validationRegex:/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/,validationMessage:"--.generic.validation.email",focus:function(){return!0},disabled:function(){return a.loading},field:a.dto,fieldName:"email"}},a.close=function(){d.close()},a.$watch("fields",function(){var b=!0;for(var c in a.fields){var d=a.fields[c];!a.fields.hasOwnProperty(c)||null!=d.isValid&&d.isValid!==!1||(d.firstAttempt=!a.displayErrorMessage,b=!1)}a.isValid=b},!0),a.$watch("displayErrorMessage",function(){for(var b in a.fields){var c=a.fields[b];c.firstAttempt=!a.displayErrorMessage}}),a.save=function(){a.isValid?(a.loading=!0,g.forgotPassword(a.dto,function(){c.success(e("translateText")("--.forgotPassword.success")),a.loading=!1,a.close()},function(){a.loading=!1})):a.displayErrorMessage=!0}}]),myApp.controller("HelpModalCtrl",["$scope","$modalInstance","message",function(a,b,c){a.message=c,a.close=function(){b.close()}}]),myApp.controller("DownloadFieldModalCtrl",["$scope","$flash","$modalInstance",function(a,b,c){a.loading=!1,a.fields={file:{fieldTitle:"generic.file",disabled:function(){return a.loading}}},a.close=function(){c.close()},a.allFieldValid=function(){var b=!0;for(var c in a.fields){var d=a.fields[c];!a.fields.hasOwnProperty(c)||null!=d.isValid&&d.isValid!==!1||(d.firstAttempt=!1,b=!1)}return b},a.save=function(){a.allFieldValid()}}]),myApp.controller("AccountFusionFacebookModalCtrl",["$scope","$flash","$modalInstance","accountFusion","accountService",function(a,b,c,d,e){a.loading=!1,a.email=d.email,a.fields={password:{name:"password",fieldTitle:"--.generic.password",validationRegex:"^[a-zA-Z0-9-_%]{6,18}$",validationMessage:"--.generic.validation.password",fieldType:"password",focus:function(){return!0},disabled:function(){return a.loading}}},a.close=function(){c.close()},a.allFieldValid=function(){var b=!0;for(var c in a.fields){var d=a.fields[c];!a.fields.hasOwnProperty(c)||null!=d.isValid&&d.isValid!==!1||(d.firstAttempt=!1,b=!1)}return b},a.save=function(){a.allFieldValid()&&(d.password=a.fields.password.field,a.loading=!0,e.accountFusion(d,function(){a.loading=!1,a.close()},function(){a.loading=!1}))}}]),myApp.controller("CustomerRegistrationModalCtrl",["$scope","$flash","$modal","$modalInstance","translationService","accountService","facebookService","modalService","fctToExecute","fctToExecuteParams",function(a,b,c,d,e,f,g,h,i,j){var k=null;a.accountParam={},a.close=function(){d.close()},a.toBusinessRegistration=function(){a.close(),h.openBusinessRegistrationModal()},a.fb_login=function(){a.accountParam.disabled=!0,a.loading=!0,g.registration(function(c){var d=c.accessToken,e=c.userID,g={userId:e,token:d,accountType:"CUSTOMER"};f.testFacebook(g,function(c){a.loading=!1,"ALREADY_REGISTRERED"==c.status?(b.success("--.customer.registrationModal.alredyRegistred.success"),f.setMyself(c.myself),a.close()):"ACCOUNT_WITH_SAME_EMAIL"==c.status?a.fusion(c.accountFusion):"OK"==c.status&&(a.accountParam.dto.firstname=c.firstname,a.accountParam.dto.lastname=c.lastname,a.accountParam.dto.email=c.email,a.accountParam.dto.gender=c.gender,a.accountParam.maskPassword(),null==a.accountParam.dto.firstname||0==a.accountParam.dto.length||null==a.accountParam.dto.lastname||0==a.accountParam.dto.lastname.length||null==a.accountParam.dto.email||0==a.accountParam.dto.email.length||null==a.accountParam.dto.gender||0==a.accountParam.dto.gender.length?(a.accountParam.disabled=!1,b.info("--.registration.facebook.someDataEmpty")):b.info("--.registration.facebook.validSLAMessage"),k=g)})},function(c,d){b.error(c.message),a.loading=!1,a.accountParam.disabled=!1})},a.fusion=function(a){h.openFacebookFusionModal(a)},a.save=function(){if(a.accountParam.isValid||null!=k){var c={accountRegistration:a.accountParam.dto,facebookAuthentication:k};a.loading=!0,f.registration(c,function(){a.loading=!1,b.success(e.get("--.login.flash.success")),null!=i&&i(j),a.close()},function(){a.loading=!1})}else a.accountParam.displayErrorMessage=!0}}]),myApp.controller("BusinessRegistrationModalCtrl",["$scope","$flash","$modal","$modalInstance","translationService","accountService","facebookService","businessService","modalService","$location","addressService",function(a,b,c,d,e,f,g,h,i,j,k){var l=null;a.badgeSelected=1,a.accountParam={},a.addressFormParam={addName:!1},a.businessCategoryFormParam={value:[]},a.businessFormParam={},a.close=function(){d.close()},a.next=function(){var c=!1;1==a.badgeSelected?(a.accountParam.isValid||null!=l?null!=l?a.badgeSelected++:(a.accountParam.disabled=!0,a.loading=!0,f.testEmail(a.accountParam.dto.email,function(c){a.accountParam.disabled=!1,a.loading=!1,c?b.error(e.get("--.error.email_already_used")):a.badgeSelected++})):(a.accountParam.displayErrorMessage=!0,b.error(e.get("--.generic.stepNotValid"))),c=!0):2==a.badgeSelected&&(c=!0,a.addressFormParam.isValid&&a.businessFormParam.isValid?(a.loading=!0,k.testAddress(a.addressFormParam.dto,function(){a.loading=!1,a.badgeSelected++},function(){a.loading=!1})):(a.addressFormParam.displayErrorMessage=!0,a.businessFormParam.displayErrorMessage=!0,b.error(e.get("--.generic.stepNotValid")))),c||a.badgeSelected++},a.fb_login=function(){a.accountParam.disabled=!0,a.loading=!0,g.registration(function(c){var d=c.accessToken,e=c.userID,g={userId:e,token:d,accountType:"BUSINESS"};f.testFacebook(g,function(c){a.loading=!1,"ALREADY_REGISTRERED"==c.status?(b.success("--.customer.registrationModal.alredyRegistred.success"),f.setMyself(c.myself),a.close()):"ACCOUNT_WITH_SAME_EMAIL"==c.status?a.fusion(c.accountFusion):"OK"==c.status&&(a.accountParam.dto.firstname=c.firstname,a.accountParam.dto.lastname=c.lastname,a.accountParam.dto.email=c.email,a.accountParam.dto.gender=c.gender,a.accountParam.maskPassword(),(null==a.accountParam.dto.firstname||0==a.accountParam.dto.length||null==a.accountParam.dto.lastname||0==a.accountParam.dto.lastname.length||null==a.accountParam.dto.email||0==a.accountParam.dto.email.length||null==a.accountParam.dto.gender||0==a.accountParam.dto.gender.length)&&(a.accountParam.disabled=!1,b.info("--.registration.facebook.someDataEmpty")),l=g)})},function(c,d){b.error(c.message),a.loading=!1,a.accountParam.disabled=!1})},a.fusion=function(a){i.openFacebookFusionModal(a)},a.previous=function(){a.badgeSelected--},a.save=function(){if(a.businessFormParam.isValid&&a.addressFormParam.isValid&&a.businessCategoryFormParam.isValid){var c=a.businessFormParam.dto;c.address=a.addressFormParam.dto,c.businessCategories=a.businessCategoryFormParam.value;var d={accountRegistration:a.accountParam.dto,facebookAuthentication:l,business:c};a.loading=!0,h.registration(d,function(c){a.loading=!1,b.success(e.get("--.registration.business.flash.success")),a.close(),j.path("/business/"+c.businessId)},function(){a.loading=!1})}else a.businessFormParam.displayErrorMessage=!0,a.addressFormParam.displayErrorMessage=!0,a.accountParam.displayErrorMessage=!0,a.businessCategoryFormParam.displayErrorMessage=!0,b.error(e.get("--.generic.stepNotValid"))}}]),myApp.controller("AddressModalCtrl",["$scope","$flash","$modalInstance","businessService","accountService","translationService","addName","dto","isBusiness","callback",function(a,b,c,d,e,f,g,h,i,j){a.loading=!1,a.update=null!=h,a.addressParam={addName:g,dto:angular.copy(h)},a.close=function(){c.close()},a.success=function(b){a.loading=!1,a.close(),null!=j&&void 0!=j&&j(b)},a.save=function(){a.addressParam.isValid?(a.loading=!0,a.update?i?d.editAddress(a.addressParam.dto,function(b){a.success(b)},function(){a.loading=!1}):e.editAddress(a.addressParam.dto,function(b){a.success(b)},function(){a.loading=!1}):e.addAddress(a.addressParam.dto,function(b){a.success(b)},function(){a.loading=!1})):a.addressParam.displayErrorMessage=!0}}]),myApp.controller("EditCustomerInterestModalCtrl",["$scope","$flash","$modal","$modalInstance","translationService","accountService","facebookService","modalService",function(a,b,c,d,e,f,g,h){a.customerInterestParam={result:f.getMyself().customerInterests},a.close=function(){d.close()},a.save=function(){a.loading=!0,f.editCustomerInterest({customerInterests:a.customerInterestParam.result},function(){a.loading=!1,a.close()},function(){a.loading=!1})}}]),myApp.controller("PromotionModalCtrl",["$scope","$flash","$modalInstance","translationService","dto","promotionService","callback","facebookService","business",function(a,b,c,d,e,f,g,h,i){a.loading=!1,a.update=null!=e,a.promotionParam={dto:angular.copy(e),business:i},a.getHeight=function(){var a={height:$(window).height()-190+"px"};return a},a.close=function(){c.close()},a.getIllustration=function(a){return a.pictures.length>0?a.pictures[O]:a.businessIllustration},a.success=function(b,c){a.loading=!1,a.close(),g()},a.save=function(c){a.promotionParam.isValid?a.promotionParam.minimalQuantity>a.promotionParam.quantity?b.error(d.get("--.promotion.validation.minimalQuantityMustBeLowerThanQuantity")):(a.loading=!0,a.update?f.edit(a.promotionParam.dto,function(b){a.success(b,c)},function(){a.loading=!1}):f.add(a.promotionParam.dto,function(b){h.sharePublication(b),a.success(b,c)},function(){a.loading=!1})):a.promotionParam.displayErrorMessage=!0}}]),myApp.controller("BusinessNotificationModalCtrl",["$scope","$flash","$modalInstance","translationService","dto","businessNotificationService","callback","facebookService","business",function(a,b,c,d,e,f,g,h,i){a.loading=!1,a.update=null!=e,a.businessNotificationParam={dto:angular.copy(e),business:i},a.getHeight=function(){var a={height:$(window).height()-190+"px"};return a},a.close=function(){c.close()},a.getIllustration=function(a){return a.pictures.length>0?a.pictures[O]:a.businessIllustration},a.success=function(b,c){console.log(b),a.loading=!1,a.close(),g()},a.save=function(b){a.businessNotificationParam.isValid?(a.loading=!0,a.update?f.edit(a.businessNotificationParam.dto,function(c){a.success(c,b)},function(){a.loading=!1}):f.add(a.businessNotificationParam.dto,function(c){b&&h.sharePublication(c),a.success(c,b)},function(){a.loading=!1})):a.businessNotificationParam.displayErrorMessage=!0}}]),myApp.controller("OneFieldModalCtrl",["$scope","$flash","facebookService","translationService","$modal","$modalInstance","accountService","$location","field","callback",function(a,b,c,d,e,f,g,h,i,j){var k={data:null};a.text={fieldTitle:i.name,validationRegex:"^.{1,255}$",validationMessage:["--.generic.validation.size","1","255"],field:k,fieldName:"data"},a.loading=!1,a.close=function(){f.close()},a.save=function(){a.text.isValid?(j(k.data),f.close()):a.text.firstAttempt=!1}}]),myApp.controller("BasicModalCtrl",["$scope","$flash","$modalInstance","businessService","accountService","translationService","param","$compile","directiveName","save","$timeout","title",function(a,b,c,d,e,f,g,h,i,j,k,l){a.title=l;var m=h("<"+i+' ng-info="param"/>')(a);k(function(){$(".inject-data:first").append(m)},1),a.loading=!1,a.param=g,a.close=function(){c.close()},a.setLoading=function(b){a.loading=b},a.save=function(){var b=!0;void 0!=g.isValid&&(b=g.isValid,g.displayErrorMessage=!0),b&&(a.loading=!0,j(a.close,a.setLoading))}}]),myApp.controller("MessageModalCtrl",["$scope","$flash","$modalInstance","$compile","title","message","save",function(a,b,c,d,e,f,g){a.message=f,a.title=e,a.loading=!1,a.close=function(){c.close()},a.save=function(){g(a.close)}}]),myApp.controller("GalleryModalCtrl",["$scope","$modalInstance","image","images",function(a,b,c,d){a.image=c,a.images=d,a.imageNb=null,a.close=function(){b.close()};for(var e in a.images)a.images[e].storedName==a.image.storedName&&(a.imageNb=e- -1);a.previous=function(){for(var b in a.images)if(a.images[b].storedName==a.image.storedName){void 0==a.images[b-1]?(a.image=a.images[a.images.length-1],a.imageNb=a.images.length):(a.image=a.images[b-1],a.imageNb=b-1- -1);break}},a.next=function(){for(var b in a.images)if(a.images[b].storedName==a.image.storedName){var c=b- -1;void 0==a.images[c]?(a.image=a.images[0],a.imageNb=1):(a.image=a.images[c],a.imageNb=b- -1- -1);break}}}]),myApp.controller("iframeModalCtrl",["$scope","$flash","$modalInstance","title","url",function(a,b,c,d,e){a.title=d,a.url=e,a.close=function(){c.close()}}]),myApp.controller("HomeCtrl",["$scope","modalService","customerInterestService","searchService","$rootScope","geolocationService","accountService","$timeout","addressService",function(a,b,c,d,e,f,g,h,i){$(window).scrollTop(0),e.$broadcast("PROGRESS_BAR_STOP"),a.displaySharePositionAdvertissement=function(){return 0==f.sharePosition&&(null==g.getMyself()||null==g.getMyself().selectedAddress)},e.$watch(function(){return f.sharePosition},function(b){a.sharePosition=b}),a.computeList=function(){a.interestDisplayed=a.customerInterests.slice(a.interestDisplayFirst,a.interestDisplayMax+a.interestDisplayFirst)},a.followedMode=!1,a.businessInfoParam={},a.businessListParam={data:[]},a.accountService=g.model,a.interestDisplayed=[],a.interestDisplayFirst=0,a.interestDisplayMax=12,c.getAll(function(b){a.customerInterests=b,a.computeList()}),a.publicationListCtrl={},a.currentPage=0,a.allLoaded=!1,a.loadSemaphore=!1,a.emptyMessage=null,a.left=function(){a.interestDisplayFirst>0&&(a.interestDisplayFirst--,a.computeList())},a.right=function(){a.interestDisplayFirst<a.customerInterests.length-a.interestDisplayMax&&(a.interestDisplayFirst++,a.computeList())},a.setFollowedMode=function(c){null==c&&(c=!a.followedMode),null==g.getMyself()?b.openLoginModal(a.switchFollowedMode,c,"--.loginModal.help.followMode"):a.switchFollowedMode(c)},a.switchFollowedMode=function(b){null!=b?a.followedMode=b:a.followedMode=!a.followedMode},a.customerRegistration=function(){b.openCustomerRegistrationModal()},a.searchByInterest=function(b){if(1==b.selected)b.selected=!1;else{for(var c in a.customerInterests)a.customerInterests[c].selected=!1;b.selected=!0}a.currentPage=0,a.allLoaded=!1,a.search()},a.$on("POSITION_CHANGED",function(){a.currentPage=0,a.allLoaded=!1,a.search()}),a.$watch("followedMode",function(b,c){b!=c&&(a.currentPage=0,a.allLoaded=!1,a.search())}),a.$on("LOGOUT",function(){a.followedMode&&(a.followedMode=!1)}),$(window).on("scroll",function(){var b=$(window).scrollTop()+$(window).height();$(".container-content").height()-b<200&&0==a.loadSemaphore&&(a.loadSemaphore=!0,a.currentPage=a.currentPage+1,a.search())});var j=function(b,c){if(0==a.currentPage&&(a.publicationListCtrl.data=[]),a.loadSemaphore=!1,a.publicationListCtrl.loading=!1,console.log("je uis le success "),null==b||0==b.length)console.log("je uis le success PAS BIEN"),a.allLoaded=!0,0==a.currentPage&&null!=c&&(console.log("je uis le success START CALLBACK"),c());else for(var d in b)a.publicationListCtrl.data.push(b[d])},k=function(b){a.businessListParam.data=b,a.businessListParam.loading=!1};a.search=function(){if(null!=f.position&&0==a.allLoaded){var b=null;for(var c in a.customerInterests)a.customerInterests[c].selected&&(b=a.customerInterests[c]);0==a.currentPage&&(a.publicationListCtrl.loading=!0,a.emptyMessage=null,a.publicationListCtrl.data=[],a.businessListParam.data=[]),a.followedMode?null!=b?d.byFollowedAndInterest(a.currentPage,b.id,function(c){j(c,function(){a.emptyMessage="followedWithInterest",a.businessListParam.loading=!0,d.nearBusinessByInterest(b.id,function(a){k(a)})})}):d.byFollowed(a.currentPage,function(b){j(b,function(){a.emptyMessage="followed",a.businessListParam.loading=!0,d.nearBusiness(function(a){k(a)})})}):null!=b?d.byInterest(a.currentPage,b.id,function(c){j(c,function(){a.emptyMessage="newsFeedWithInterest",a.businessListParam.loading=!0,d.nearBusinessByInterest(b.id,function(a){k(a)})})}):d["default"](a.currentPage,function(b){j(b,function(){a.emptyMessage="newsFeed",a.businessListParam.loading=!0,d.nearBusiness(function(a){k(a)})})})}},a.createNewAddress=function(){null!=g.getMyself()?a.createNewAddressLaunch():b.openLoginModal(a.createNewAddressLaunch,null,"--.loginModal.help.address")},a.createNewAddressLaunch=function(){b.addressModal(!0,null,!1,function(a){h(function(){i.changeAddress(a.name,function(a){g.getMyself().selectedAddress=a,h(function(){e.$broadcast("CHANGE_ADDRESS_SELECTED")},1)})},1)})},null!=f.position&&(a.currentPage=0,a.allLoaded=!1,a.search())}]),myApp.controller("ProfileCtrl",["$scope","modalService","accountService","$rootScope","$window",function(a,b,c,d,e){$(window).scrollTop(0),d.$broadcast("PROGRESS_BAR_STOP"),a.model=c.model,a.accountParam={updateMode:!0,dto:angular.copy(c.getMyself()),disabled:!0},a.editPassword=function(){b.openEditPasswordModal()},a.interestEdit=function(){b.openEditCustomerInterest()},a.personalEdit=function(){a.oldLang=angular.copy(a.accountParam.dto.lang),a.accountParam.disabled=!1},a.personalSave=function(){a.accountParam.disabled=!0,c.editAccount(a.accountParam.dto,function(){a.oldLang!=a.accountParam.dto.lang&&e.location.reload()})},a.personalCancel=function(){a.accountParam.dto.firstname=c.getMyself().firstname,a.accountParam.dto.lastname=c.getMyself().lastname,a.accountParam.dto.email=c.getMyself().email,a.accountParam.dto.gender=c.getMyself().gender,a.accountParam.disabled=!0},a.addAddress=function(){b.addressModal(!0,null,!1)},a.editAddress=function(a){b.addressModal(!0,a,!1)},a.deleteAddress=function(a){c.deleteAddress(a)}}]),myApp.controller("BusinessCtrl",["$rootScope","$scope","modalService","businessService","$routeParams","accountService","$window","addressService","geolocationService","translationService","$flash","$timeout","contactService","$filter","$location",function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o){$(window).scrollTop(0),a.$broadcast("PROGRESS_BAR_STOP"),null!=e.publicationId&&(b.publicationIdToGo=e.publicationId),b.displayError=!1,b.loading=!0,b.business=null,b.edit=!1,b.myBusiness=!1,b.businessId=e.businessId,b.publicationOptions=[{key:"BASIC",value:"--.business.publication.basic"},{key:"ARCHIVE",value:"--.business.publication.archive"}],b.publicationListParam={businessId:b.businessId,scrollTo:b.publicationIdToGo,displayRemoveIcon:b.edit,type:"BASIC"},b.$watch("edit",function(){b.publicationListParam.displayRemoveIcon=b.edit}),b.googleMapParams={},d.getBusiness(e.businessId,function(a){b.loading=!1,b.business=a,b.$watch("business.businessStatus",function(){null!=f.getMyself()&&f.getMyself().businessId==e.businessId&&("WAITING_CONFIRMATION"!=b.business.businessStatus&&(b.edit=!0),b.myBusiness=!0),b.myBusiness&&b.publicationOptions.push({key:"PREVISUALIZATION",value:"--.business.publication.previsualization"})}),b.computeDistance=function(){h.distance(b.business.address.id,function(a){b.business.distance=a.distance})},null!=i.position&&b.computeDistance(),b.$on("POSITION_CHANGED",function(){b.computeDistance()}),b.publish=function(){c.messageModal("--.business.page.askPublication.window.title","--.business.page.askPublication.window.message",function(a){d.publishBusiness(),a(),k.info(j.get("--.business.page.askPublication.window.flash")),b.business.businessStatus="WAITING_CONFIRMATION"})},b.cancelPublishRequest=function(){c.messageModal("--.business.page.cancelPublishRequest.window.title","--.business.page.cancelPublishRequest.window.message",function(a){d.cancelPublishRequest(),a(),k.info(j.get("--.business.page.cancelPublishRequest.window.flash")),b.business.businessStatus="NOT_PUBLISHED"})},b.stopPublish=function(){c.messageModal("--.business.page.stopPublication.window.title","--.business.page.stopPublication.window.message",function(a){d.stopPublication(),a(),k.info(j.get("--.business.page.stopPublication.window.flash")),b.business.businessStatus="NOT_PUBLISHED"})},b.editbusiness=function(){var a=angular.copy(b.business);c.basicModal("--.business.edit.data.modal.title","business-form-ctrl",{dto:a,status:a.businessStatus},function(c,e){d.edit(a,function(a){b.business.name=a.name,b.business.description=a.description,b.business.phone=a.phone,b.business.website=a.website,b.business.email=a.email,c()},function(){e(!1)})})},b.editIllustration=function(){var a=angular.copy(b.business);c.basicModal("--.business.edit.illustration.modal.title","image-form-ctrl",{dto:a,target:"business_illustration",fieldName:"illustration",details:"--.business.logo.edit.modal.description"},function(c,e){d.editIllustration(a.illustration,function(){b.business.illustration=a.illustration,c()},function(){e(!1)})})},b.editLandscape=function(){var a=angular.copy(b.business);c.basicModal("--.business.edit.landscape.modal.title","image-form-ctrl",{dto:a,target:"business_landscape",fieldName:"landscape",details:"--.business.landscape.edit.modal.description"
},function(c,e){d.editLandscape(a.landscape,function(){b.business.landscape=a.landscape,c()},function(){e(!1)})})},b.googleMapParams.address=b.business.address,l(function(){b.googleMapParams.refreshNow()},1),b.editAddress=function(){var a=angular.copy(b.business.address);c.basicModal("--.business.edit.address.modal.title","address-form-ctrl",{dto:a,addName:!1},function(c,e){d.editAddress(a,function(a){b.business.address=a,b.googleMapParams.setAddress(a),c()},function(){e(!1)})})},b.categoryLineParams={categories:b.business.categories},b.editCategory=function(){var a=[];for(var e in b.business.categories){var f=b.business.categories[e];for(var g in f){var h=f[g];for(var i in h)a.push(h[i])}}c.basicModal("--.business.edit.category.modal.title","business-category-form-ctrl",{value:a},function(c,e){d.editBusinessCategory(a,function(a){b.business.categories=a.categories,b.categoryLineParams.categories=b.business.categories,c()},function(){e(!1)})})},b.editSchedule=function(){var a=angular.copy(b.business.schedules);c.basicModal("--.business.edit.schedule.modal.title","schedule-form-ctrl",{dto:a,disabled:!1},function(c,e){d.createSchedule({schedules:a},function(d){b.business.schedules=a,c()},function(){e(!1)})})},b.editGallery=function(){var a=angular.copy(b.business);c.basicModal("--.business.edit.address.modal.title","dir-field-image-mutiple",{fieldTitle:"--.business.modal.gallery.title",validationMessage:"--.error.validation.image",help:"--.business.gallery.download.help",details:"--gallery.maximumImage",field:a,maxImage:10,multiple:!0,target:"galley_picture",fieldName:"galleryPictures"},function(c,e){d.editGallery({list:a.galleryPictures},function(a){b.business.galleryPictures=a,c()},function(){e(!1)})})},b.editSocialNetwork=function(){var a=angular.copy(b.business.socialNetwork);(void 0==a||null==a)&&(a={}),c.basicModal("--.business.edit.socialNetwork.modal.title","business-social-network-ctrl",{dto:a},function(c,e){d.editSocialNetwork(a,function(d){b.business.socialNetwork=a,c()},function(){e(!1)})})},b.createPromotion=function(){c.openPromotionModal(null,b.business,function(){b.$broadcast("RELOAD_PUBLICATION")})},b.createNotification=function(){c.openBusinessNotificationModal(null,b.business,function(){b.$broadcast("RELOAD_PUBLICATION")})},b.$on("POSITION_CHANGED",function(){b.$broadcast("RELOAD_PUBLICATION")}),b.$watch("publicationListParam.type",function(a,c){a!=c&&b.$broadcast("RELOAD_PUBLICATION")}),b.$on("RELOAD_PUBLICATION",function(){b.publicationListParam.refresh(b.publicationListParam.type)}),null!=i.currentPosition&&b.$broadcast("RELOAD_PUBLICATION"),b.displaySchedule=function(){for(var a in b.business.schedules)if(b.business.schedules[a].length>0)return!0;return!1},b.displaySocialNetwork=function(){var a=b.business.socialNetwork;return null==a?!1:null!=a.facebookLink||null!=a.twitterLink||null!=a.instagramLink||null!=a.deliveryLink||null!=a.opinionLink||null!=a.reservationLink},b.computeProgression=function(){var a=0;return null!=b.business.description&&a++,null!=b.business.illustration&&a++,null!=b.business.landscape&&a++,b.business.galleryPictures.length>0&&a++,b.displaySocialNetwork()&&a++,b.displaySchedule()&&a++,a},b.getProgressionStyle=function(){var a="width:"+300*(b.computeProgression()/5)+"px";return console.log(a),a},b.openContact=function(){var a={target:"HELP"};c.basicModal("--.contactForm.modal.title","contact-form-ctrl",{dto:a},function(b){m.contact(a,function(){k.success(n("translateText")("--.contactForm.send.success")),b()})})}},function(){b.loading=!1,b.displayError=!0})}]),myApp.controller("SearchPageCtrl",["$rootScope","$scope","searchService","$routeParams","searchBarService","geolocationService",function(a,b,c,d,e,f){$(window).scrollTop(0),a.$broadcast("PROGRESS_BAR_STOP");var g=d.param;e.setCurrentSearch(g),b.businessTab={currentPage:0},b.categoryTab={currentPage:0},b.publicationTab={currentPage:0},b.results=null,b.search=function(){c.searchByString(0,g,function(a){b.businessTab.display=!1,b.categoryTab.display=!1,b.publicationTab.display=!1;var d=0;for(var f in e.searchCriteria)e.searchCriteria[f].selected&&("business"==e.searchCriteria[f].key?b.businessTab.display=!0:"category"==e.searchCriteria[f].key?b.categoryTab.display=!0:"publication"==e.searchCriteria[f].key&&(b.publicationTab.display=!0),d++);0==d&&(b.businessTab.display=!0,b.categoryTab.display=!0,b.publicationTab.display=!0),b.results=a;var g=!1;if(b.businessTab.display&&(b.businessTab.total=b.results.businesses.length,!g&&b.businessTab.total>0&&(b.businessTab.active=!0,g=!0),b.businessTab.totalToDisplay=b.businessTab.total,20==b.results.businesses.length&&(b.businessTab.totalToDisplay+="+")),b.publicationTab.display&&(b.publicationTab.total=b.results.publications.length,!g&&b.publicationTab.total>0&&(b.publicationTab.active=!0,g=!0),b.publicationTab.totalToDisplay=b.publicationTab.total,20==b.results.publications.length&&(b.publicationTab.totalToDisplay+="+")),b.categoryTab.display){b.categoryTab.total=0;for(var h in b.results.categoriesMap)for(var i in b.results.categoriesMap[h])for(var j in b.results.categoriesMap[h][i])b.categoryTab.total+=b.results.categoriesMap[h][i][j].length,20==b.results.categoriesMap[h][i][j].length&&(b.categoryTab.loadCategory=!0);!g&&b.categoryTab.total>0&&(b.categoryTab.active=!0,g=!0),b.categoryTab.totalToDisplay=b.categoryTab.total,b.categoryTab.total>=20&&(b.categoryTab.totalToDisplay+="+")}b.businessTab.data=b.results.businesses,b.publicationTab.data=b.results.publications,b.categoryTab.data=b.results.categoriesMap,b.loadSemaphore=!1,$(window).on("scroll",function(){var a=$(window).scrollTop()+$(window).height();$(".container-content").height()-a<200&&b.search()}),b.search=function(){if(0==b.loadSemaphore){b.loadSemaphore=!0;var a;if(b.businessTab.active?(a=b.businessTab,console.log("business load more...")):b.publicationTab.active?(a=b.publicationTab,console.log("business load more...")):b.categoryTab.active&&(a=b.categoryTab,console.log("business load more...")),20==a.total&&1!=a.allLoaded){var d=e.currentSearch;-1!=d.indexOf(":")&&(d=d.split(":")[1]),a.currentPage++,b.businessTab.active?(d="business:"+d,c.searchByString(a.currentPage,d,function(c){if(b.loadSemaphore=!1,0==c.businesses.length)a.allLoaded=!0;else for(var d in c.businesses)a.data.push(c.businesses[d])})):b.publicationTab.active?(d="publication:"+d,c.searchByString(a.currentPage,d,function(c){if(b.loadSemaphore=!1,0==c.publications.length)a.allLoaded=!0;else for(var d in c.publications)a.data.push(c.publications[d])})):b.categoryTab.active&&b.categoryTab.loadCategory===!0&&(d="category:"+d,c.searchByString(a.currentPage,d,function(c){b.loadSemaphore=!1;var d=b.fusionCategories(c.categoriesMap);0==d&&(a.allLoaded=!0)}))}}}})},b.fusionCategories=function(a){var c=0;for(var d in a){var e=!1;for(var f in b.results.categoriesMap)if(f==d){e=!0;break}if(e)for(var g in a[d]){var h=!1;for(var i in b.results.categoriesMap[d])if(i==g){h=!0;break}if(h)for(var j in a[d][g]){var k=!1;for(var l in b.results.categoriesMap[d][g])if(l==j){k=!0;break}if(k)for(var m in a[d][g][j])b.results.categoriesMap[d][g][j].push(a[d][g][j][m]),c++;else b.results.categoriesMap[d][g].newSSCat=a[d][g][j]}else b.results.categoriesMap[d].newSCat=a[d][g]}else b.results.categoriesMap.newCat=a[d]}return c},null!=f.position&&b.search(),b.$on("POSITION_CHANGED",function(){b.search()})}]),myApp.controller("FollowedBusinessPageCtrl",["$rootScope","$scope","businessService","ngTableParams","$filter","followService",function(a,b,c,d,e,f){$(window).scrollTop(0),a.$broadcast("PROGRESS_BAR_STOP"),b.businessListParams={loading:!0},c.getFollowedBusinesses(function(a){b.businesses=a,b.$watch("filter.$",function(a,c){c!=a&&b.tableParams.reload()}),b.tableParams=new d({page:1,count:10,sorting:{name:"asc"}},{counts:[],total:b.businesses.length,getData:function(a,c){var d=e("filter")(b.businesses,b.filter),f=c.sorting()?e("orderBy")(d,c.orderBy()):d;a.resolve(f.slice((c.page()-1)*c.count(),c.page()*c.count()))}}),b.checkAll=function(a){for(var c in b.businesses)b.businesses[c].followingNotification!=a&&(b.businesses[c].followingNotification=a,b.setNotification(b.businesses[c]))},b.setNotification=function(a){f.setNotification(a.id,a.followingNotification)},b.stopFollow=function(a){f.addFollow(!1,a.id,function(){for(var c in b.businesses)b.businesses[c]==a&&b.businesses.splice(c,1);b.tableParams.reload()})}},function(){b.loading=!1,b.displayError=!0})}]),myApp.directive("publicationListCtrl",["$rootScope","businessService","geolocationService","directiveService","searchService","$location","modalService",function(a,b,c,d,e,f,g){return{restrict:"E",scope:d.autoScope({ngInfo:"="}),templateUrl:"/assets/javascripts/directive/component/publicationList/template.html",replace:!0,transclude:!0,compile:function(){return{post:function(a){d.autoScopeImpl(a),a.click=function(){console.log(a.publication)},a.getInfo().loading=!0,a.navigateTo=function(a){f.path(a)},a.$watch("getInfo().data",function(){a.publications=a.getInfo().data;for(var b in a.publications)a.publications[b].interval=a.publications[b].endDate-new Date}),a.getInterestClass=function(a){return null!=a.interest?"gling-icon-"+a.interest.name:null};var b=function(a){return void 0==a||null===a||""===a};a.descriptionIsEmpty=function(a){return"PROMOTION"!=a.type&&b(a.description)},a.openGallery=function(a,b){g.galleryModal(a,b.pictures)}}}}}}]),myApp.directive("publicationWidgetCtrl",["$rootScope","businessService","geolocationService","directiveService","searchService","$location","modalService",function(a,b,c,d,e,f,g){return{restrict:"E",scope:d.autoScope({ngInfo:"="}),templateUrl:"/assets/javascripts/directive/component/publicationWidget/template.html",replace:!0,transclude:!0,compile:function(){return{post:function(a){d.autoScopeImpl(a),a.click=function(){console.log(a.publication)},a.navigateTo=function(a){f.path(a)},a.getInterestClass=function(a){return null!=a.interest?"gling-icon-"+a.interest.name:null};var b=function(a){return void 0==a||null===a||""===a};a.descriptionIsEmpty=function(a){return"PROMOTION"!=a.type&&b(a.description)},a.openGallery=function(a,b){g.galleryModal(a,b.pictures)}}}}}}]),myApp.directive("publicationListForBusinessCtrl",["$rootScope","businessService","geolocationService","directiveService","searchService","$timeout","publicationService","modalService",function(a,b,c,d,e,f,g,h){return{restrict:"E",scope:d.autoScope({ngInfo:"="}),templateUrl:"/assets/javascripts/directive/component/publicationListForBusiness/template.html",replace:!0,transclude:!0,compile:function(){return{post:function(b){d.autoScopeImpl(b),b.currentPage=0,b.allLoaded=!1,b.loadSemaphore=!1,b.publications=[],b.success=function(a){0==b.currentPage&&(b.publications=[]),0==a.length&&(b.allLoaded=!0),b.loadSemaphore=!1;for(var c in a)b.publications.push(a[c]);for(var d in b.publications)b.publications[d].interval=(b.publications[d].endDate-new Date)/1e3;null!=b.getInfo().scrollTo&&f(function(){var a="#publication"+b.getInfo().scrollTo;$(window).scrollTop($(a).offset().top-70),b.getInfo().scrollTo=null,b.$apply()},1)},$(window).on("scroll",function(){var a=$(window).scrollTop()+$(window).height();$(".container-content").height()-a<200&&0==b.loadSemaphore&&(b.loadSemaphore=!0,b.currentPage=b.currentPage+1,b.search())}),b.getInfo().refresh=function(a){b.currentPage=0,b.publications=[],b.type=a,b.search()},b.search=function(){1!=b.allLoaded&&(null!=b.type&&void 0!=b.type&&"ARCHIVE"==b.type?e.byBusinessArchived(b.currentPage,b.getInfo().businessId,b.success):null!=b.type&&void 0!=b.type&&"PREVISUALIZATION"==b.type?e.byBusinessPrevisualization(b.currentPage,b.getInfo().businessId,b.success):e.byBusiness(b.currentPage,b.getInfo().businessId,b.success))},b.$watch("type",function(a,c){a!=c&&(b.allLoaded=!1,b.search())}),b.removePublication=function(b){h.messageModal("--.business.publication.remove.confirmationModal.title","--.business.publication.remove.confirmationModal.body",function(c){g["delete"](b,function(){a.$broadcast("RELOAD_PUBLICATION"),c()})})},b.getInterestClass=function(a){return null!=a.interest?"gling-icon-"+a.interest.name:null};var c=function(a){return void 0==a||null===a||""===a};b.descriptionIsEmpty=function(a){return"PROMOTION"!=a.type&&c(a.description)},b.openGallery=function(a,b){h.galleryModal(a,b.pictures)}}}}}}]),myApp.directive("businessListCtrl",["$rootScope","businessService","geolocationService","directiveService","searchService","$location",function(a,b,c,d,e,f){return{restrict:"E",scope:d.autoScope({ngInfo:"="}),templateUrl:"/assets/javascripts/directive/component/businessList/template.html",replace:!0,transclude:!0,compile:function(){return{post:function(a){d.autoScopeImpl(a),a.getInfo().loading=!0,a.navigateTo=function(a){f.path(a)},a.$watch("getInfo().data",function(){a.businesses=a.getInfo().data})}}}}}]),myApp.directive("categoryLineCtrl",["$rootScope","businessService","geolocationService","directiveService","$location",function(a,b,c,d,e){return{restrict:"E",scope:d.autoScope({ngInfo:"="}),templateUrl:"/assets/javascripts/directive/component/categoryLine/template.html",replace:!0,transclude:!0,compile:function(){return{post:function(a){d.autoScopeImpl(a),a.searchCat=function(a){e.path("/search/category:"+a)}}}}}}]),myApp.directive("headerBarCtrl",["addressService","$rootScope","languageService","$location","accountService","facebookService","modalService","$timeout","geolocationService","addressService",function(a,b,c,d,e,f,g,h,i,a){return{restrict:"E",scope:{},templateUrl:"/assets/javascripts/directive/web/headerBar/template.html",replace:!0,compile:function(){return{post:function(j){j.currentLang=c.currentLang,j.myself=e.getMyself(),j.accountService=e,j.navigateTo=function(a){d.path(a)},j.login=function(){g.openLoginModal()},j.registration=function(){g.openCustomerRegistrationModal()},j.editProfile=function(){g.openEditProfileModal()},j.logout=function(){f.isConnected()&&f.logout(),b.$broadcast("LOGOUT"),e.logout(function(){d.path("/")})},j.$watch("lang",function(){angular.isUndefined(j.lang)||c.changeLanguage(j.lang)}),j.languageService=c,j.positionBasicData=[{key:"currentPosition",translation:"--.position.current"},{key:"createNewAddress",translation:"--.position.newAddress"}],j.positions=angular.copy(j.positionBasicData),j.currentPositionText="currentPosition",b.$on("CHANGE_ADDRESS",function(a){j.currentPosition=a.address.name}),j.createNewAddress=function(a){j.currentPosition=a,g.addressModal(!0,null,!1,function(a){h(function(){j.currentPosition=a.name},1)})},b.$on("CHANGE_ADDRESS_SELECTED",function(){return null==e.getMyself().selectedAddress?void(j.currentPosition="currentPosition"):void(j.currentPosition=e.getMyself().selectedAddress.name)}),h(function(){k(),j.$watch("currentPosition",function(c,d){null!=c&&d!=c&&("createNewAddress"==j.currentPosition&&(null!=e.getMyself(d)?j.createNewAddress():g.openLoginModal(j.createNewAddress,d,"--.loginModal.help.address")),j.currentPosition!=j.positionCurrenltyComputed&&(j.positionCurrenltyComputed=j.currentPosition,a.changeAddress(j.currentPosition,function(a){null!=e.getMyself()&&(-1==a.__type.indexOf("AddressDTO")?e.getMyself().selectedAddress=null:e.getMyself().selectedAddress=a),h(function(){b.$broadcast("POSITION_CHANGED")},1)})))}),b.$watch(function(){return e.model.myself},function(a,b){k()})},1);var k=function(){if(j.positions=angular.copy(j.positionBasicData),null!=e.getMyself())for(var a in e.getMyself().addresses)j.positions.splice(j.positions.length-1,0,{key:e.getMyself().addresses[a].name,translation:e.getMyself().addresses[a].name});j.currentPosition=i.getLocationText()};b.$watch(function(){return e.model.myself},function(a,b){k()},!0)}}}}}]),myApp.directive("footerBarCtrl",["modalService","contactService","$flash","$filter",function(a,b,c,d){return{restrict:"E",scope:{},templateUrl:"/assets/javascripts/directive/web/footerBar/template.html",replace:!0,compile:function(){return{post:function(e){e.openContactForm=function(e){var f={target:e};a.basicModal("--.contactForm.modal.title","contact-form-ctrl",{dto:f},function(a){b.contact(f,function(){c.success(d("translateText")("--.contactForm.send.success")),a()})})}}}}}}]),myApp.directive("toTopCtrl",["$window",function(a){return{restrict:"E",scope:{},templateUrl:"/assets/javascripts/directive/component/toTop/template.html",replace:!0,transclude:!0,compile:function(){return{post:function(b){b.toTop=function(){$(window).scrollTop(0)},b.displayToTopButton=$(window).scrollTop()>100,angular.element(a).bind("scroll",function(){b.displayToTopButton=$(window).scrollTop()>100,b.$apply()})}}}}}]),myApp.service("$flash",["$filter",function(a){Messenger.options={extraClasses:"messenger-fixed messenger-on-bottom messenger-on-right cr-messenger",theme:"block"},this.success=function(a){print(a,"success")},this.info=function(a){print(a,"info")},this.error=function(a){print(a,"error")},this.warning=function(a){print(a,"warning")},print=function(a,b){if(!angular.isUndefined(a)&&null!==a)for(var c in a.split("\n")){var d=a.split("\n")[c];Messenger().post({message:d,type:b,showCloseButton:!0})}}}]);