...
angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put("js/directive/component/followWidgetForPublication/template.html",
    "<div class=follow-widget><div class=follow-text ng-hide=\"getInfo().displayText===true\"><div>{{'--.followWidget.follow' | translateText:null:true}}</div></div><div class=follow-widget-icon ng-click=follow() ng-hide=\"getInfo().displayText===true\"><button><span class=\"gling-icon gling-icon-bell selected\" ng-show=getInfo().publication.following></span><span class=\"gling-icon gling-icon-bell2\" ng-hide=getInfo().publication.following></span></button></div><button class=\"gling-button-dark gling-button-dark-little follow-text\" ng-show=\"getInfo().displayText===true\" ng-click=follow()><div ng-hide=getInfo().publication.following><i class=\"gling-icon gling-icon-bell2\"></i><span>{{'--.followWidget.followBusiness' | translateText}}</span></div><div ng-show=getInfo().publication.following><i class=\"gling-icon gling-icon-bell\"></i><span>{{'--.followWidget.stopFollowBusiness' | translateText}}</span></div></button></div>");
  ...
  $templateCache.put("js/directive/component/map/businessForMap/template.html",
    "<div class=business-for-map><div class=business-header ng-click=\"goTo('/business/'+getInfo().business.id)\"><img class=business-illustration ng-src=\"{{getInfo().business.illustrationName | image}}\"><i class=\"gling-icon gling-icon-bell\" ng-show=\"getInfo().business.following === true\"></i><span class=title>{{getInfo().business.name}}</span><span class=currently-open ng-show=getInfo().business.isOpen>{{'--.schedule.isOpenNow' | translateText}}</span></div><category-line-ctrl ng-info={categories:getInfo().business.categories,level1:false}></category-line-ctrl>{{getInfo().business.street}},{{getInfo().business.zip}}<br><follow-widget-ctrl ng-info={displayText:true,business:getInfo().business}></follow-widget-ctrl></div>");
  ...
  $templateCache.put("js/directive/form/businessCreationForm/template.html",
  ...
  $templateCache.put("js/directive/form/claimBusiness/template.html",
    "<div class=form><div ng-bind-html=\"'--.business.claim.form.desc' | translateText | text\"></div><dir-field-text ng-info=fields.phone></dir-field-text><dir-field-text ng-info=fields.vta></dir-field-text></div>");
  ...
  $templateCache.put("js/directive/mobile/headerSearch/template.html",
    "<div class=\"navbar navbar-app navbar-absolute-top\" ng-class=\"{'header-with-advanced-search':advancedSearch}\"><div class=\"navbar-brand navbar-brand-center header-option-container\" style=\"padding-top: 5px\"><search-bar-ctrl ng-info={mobile:true}></search-bar-ctrl></div><div class=\"btn-group pull-left\"><div class=\"btn btn-navbar\" ng-click=back() ng-hide=\"displayMenu !== false\"><div class=nav-button ng-show=displayBack()><i class=\"glyphicon glyphicon-chevron-left\"></i></div></div><div class=\"btn btn-navbar nav-menu\" ng-click=showMenu() ng-show=\"displayMenu !== false\"><div class=nav-button><i class=\"gling-icon gling-icon-menu\"></i></div></div></div></div>");
  ...
  $templateCache.put("js/modal/PromotionModal/view.html",
    "<div class=modal-header><button class=\"gling-button-dark glyphicon glyphicon-remove\" style=float:right ng-click=close()></button><h4 ng-show=update class=modal-title>{{'--.promotion.modal.title.update' | translateText}}</h4><h4 ng-hide=update class=modal-title>{{'--.promotion.modal.title.create' | translateText}}</h4></div><div class=modal-body ng-style=getHeight()><promotion-form-ctrl ng-info=promotionParam></promotion-form-ctrl></div><div class=modal-footer><button ng-disabled=loading id=promotion-modal-btn-save type=button class=\"btn gling-button-dark\" ng-click=save(false)>{{'--.generic.save' | translateText}}</button> <img src=/assets/images/modal-loading.gif ng-show=\"loading\"></div>");
  ...
  $templateCache.put("js/modal/admin/ConfirmClaimModal/view.html",
    "<div class=modal-header><button class=\"button-gling-dark glyphicon glyphicon-remove\" ng-click=close() style=float:right></button><h4 class=modal-title>{{business.name}} réclamation</h4></div><div class=\"modal-body modal-login business-registration\">Listes des personnes réclamant le commerce<tabset><tab active=claim.active ng-repeat=\"claim in claims\"><tab-heading>{{claim.account.firstname}} ({{claim.account.lastname}})</tab-heading><table class=table-basic><tr><td>nom</td><td>{{claim.account.firstname}} {{claim.account.lastname}}</td></tr><tr><td>email</td><td>{{claim.account.email}}</td></tr><tr><td>téléphone</td><td>{{claim.phone}}</td></tr><tr><td>tva</td><td>{{claim.vta}}</td></tr><tr><td colspan=2><button class=\"btn gling-button-dark\" ng-click=confirm(claim) type=button ng-disabled=loading>{{'--.generic.confirm' | translateText}}</button><img ng-show=loading src=/assets/images/modal-loading.gif></td></tr></table></tab></tabset></div>");
  ...
  $templateCache.put("js/view/admin/adminStat.html",
    "<super-admin-menu-ctrl></super-admin-menu-ctrl><div class=my-tabs><div ng-click=\"setTab('main')\" ng-class=\"{'selected':tab == 'main'}\">Statistiques</div><div ng-click=\"setTab('users')\" ng-class=\"{'selected':tab == 'users'}\">Détails utilisateurs</div><div ng-click=\"setTab('interest')\" ng-class=\"{'selected':tab == 'interest'}\">Intérêts</div></div><div ng-show=\"tab == 'main'\"><h1>Stats</h1><table class=admin_stat><tr ng-repeat=\"(title, val) in stats\"><td>{{title}}</td><td>{{val.value1}}</td><td>{{val.value2 * 100 | number:2}} %</td></tr></table><button ng-click=refreshStat()>Refrech</button></div><div ng-show=\"tab == 'users'\"><h1>User Details</h1><table><tr ng-repeat=\"detail in details\"><td>{{detail.title}} ({{detail.total}})<div ng-repeat=\"a in detail.accounts\">{{a.email}}</div></td><td style=\"vertical-align: top\"><donut-chart-ctrl style=\"width: 300px;height: 300px;display: inline-block\" ng-info=detail.nbSessionChartParam></donut-chart-ctrl></td><td><donut-chart-ctrl style=\"width: 300px;height: 300px;display: inline-block\" ng-info=detail.nbFollowChartParam></donut-chart-ctrl></td><td><donut-chart-ctrl style=\"width: 300px;height: 300px;display: inline-block\" ng-info=detail.nbAddressChartParam></donut-chart-ctrl></td><td><donut-chart-ctrl style=\"width: 300px;height: 300px;display: inline-block\" ng-info=detail.sharePositionChartParam></donut-chart-ctrl></td></tr><tr collapse=2><button ng-click=refreshDetails()>Refrech</button></tr></table></div><div ng-show=\"tab == 'interest'\"><h1>Intérêts</h1><donut-chart-ctrl style=\"width: 600px;height: 600px;display: inline-block\" ng-info=interestGraph1></donut-chart-ctrl><donut-chart-ctrl style=\"width: 600px;height: 600px;display: inline-block\" ng-info=interestGraph7></donut-chart-ctrl><donut-chart-ctrl style=\"width: 600px;height: 600px;display: inline-block\" ng-info=interestGraph14></donut-chart-ctrl><donut-chart-ctrl style=\"width: 600px;height: 600px;display: inline-block\" ng-info=interestGraph28></donut-chart-ctrl><button ng-click=refreshInterest()>Refrech</button></div>");
  ...
  $templateCache.put("js/view/web/welcome.html",
    "<div class=welcome-page><div class=welcome-header><div class=\"gling-icon gling-icon-logoapp logo\"></div><p>What's up in my shops</p></div><div class=left-column><div class=\"block-title block-title-left block-title-first\">{{'--.welcome.thisWeek' | translateText}}</div><div class=event-block><img src=/assets/images/event/noel.jpg><span class=event-title>{{'--.welcome.event.christmas.title' | translateText}}</span><br><br><span ng-bind-html=\"'--.welcome.event.christmas.content' | translateText | text\"></span></div><div class=event-block><div class=event-publications><div class=event-title>{{'--.welcome.event.christmas.publication.content' | translateText}}</div><div class=event-publication ng-repeat=\"p in eventPublications\"><img ng-src=\"{{p.pictures[0] | image}}\" ng-click=goToPublication(p)><div class=title>{{p.title}}</div><div>By<span class=link ng-click=\"goTo('/business/'+p.businessId)\">{{p.businessName}}</span></div></div></div><button class=gling-button-dark ng-click=\"goTo('/shopnews/shopping)\">{{'--.welcome.more_gift' | translateText}}</button></div><div class=\"block-title block-title-left\">{{'--.welcome.lastPublications' | translateText}}<div class=\"see-more link\" ng-click=\"goTo('/shopnews/')\">{{'--.welcome.seeMore' | translateText}}</div></div><publication-list-ctrl ng-info=publicationListCtrl></publication-list-ctrl><div class=\"link center\" ng-click=\"goTo('/shopnews/')\">{{'--.welcome.morePublications' | translateText}}</div></div><div class=right-column><div class=\"block-title block-title-first\">{{'--.welcome.joinOnFacebook' | translateText}}</div><div class=fb-post data-width=380 data-href=https://www.facebook.com/gling.be/posts/1699063293642611:0></div><div class=block-title>{{'--.welcome.neighborhood' | translateText}}<div class=\"see-more link\" ng-click=\"goTo('/map/')\">{{'--.welcome.seeMore' | translateText}}</div></div><div class=map-container><flex-slider pauseonhover=true flex-slide=\"map in maps track by $index \" animation=slide><li><div class=map-slider ng-click=openMap(map) style=cursor:pointer><div>{{map.name}}</div></div><img ng-src={{map.src}} ng-click=openMap(map) style=cursor:pointer></li></flex-slider></div><div class=block-title>{{'--.welcome.lastBusinesses' | translateText}}</div><div class=welcome-business-list><div class=welcome-business-list-el ng-repeat=\"business in businesses\"><table><tr><td ng-click=\"goTo('/business/'+business.id)\" rowspan=2><img class=illustration ng-src=\"{{business.illustration | image}}\"></td><td ng-click=\"goTo('/business/'+business.id)\"><div class=title>{{business.name}}</div></td></tr><tr><td><div class=address>{{business.address.street}}, {{business.address.zip}} {{business.address.city}} - {{business.distance / 1000 | number:2}} km<br></div></td></tr></table><category-line-ctrl ng-info={categories:business.categories,level1:false}></category-line-ctrl><div class=welcome-business-action><follow-widget-ctrl ng-info={displayText:true,business:business}></follow-widget-ctrl></div></div></div></div></div>");
}]);
