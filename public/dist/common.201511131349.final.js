...
angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put("/assets/javascripts/directive/component/publicationList/template.html",
    "<div class=publication-list><div ng-show=\"getInfo().loading!=true && publications.length == 0\">{{'--.list.nothing' | translateText}}</div><publication-widget-ctrl ng-repeat=\"publication in publications\" ng-info={publication:publication}></publication-widget-ctrl><div ng-show=\"getInfo().loading===true\" class=loading><img src=\"/assets/images/big_loading.gif\"></div></div>");
