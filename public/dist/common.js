...
angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put("/assets/javascripts/view/mobile/search_page.html",
    "<header-search-ctrl></header-search-ctrl><div></div>");
