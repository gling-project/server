...
angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put("/assets/javascripts/directive/mobile/title/template.html",
    "<div class=\"navbar navbar-app navbar-absolute-top\"><div class=\"navbar-brand navbar-brand-center\">{{title | translateText}}</div><div class=\"btn-group pull-left\"><div class=\"btn btn-navbar\"><div class=nav-button ng-click=back() ng-show=displayBack() ng-hide=displayMenu><i class=\"glyphicon glyphicon-chevron-left\"></i></div><div ui-toggle=uiSidebarLeft class=nav-button ng-show=displayMenu><i class=\"fa fa-bars\"></i></div></div></div></div>");
