...
angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put("js/view/web/welcome.html",
    "<div class=container-content><div class=content-block><div class=welcome-page><div class=welcome-header><div class=\"gling-icon gling-icon-logoapp logo\"></div><p>What's up in my shops</p></div><div class=left-column><div class=event-block><div class=block-title>Cette semaine près de chez vous !</div><div class=event_el><img src=/assets/images/event/sn.jpg></div><div class=event_el><div class=block-title>Saint Nicolas a aussi ses commerces de proximité favoris!</div><p>Magasins de jeux et jouets, marchand de spéculoos et même légumier pour ses carottes… Saint Nicolas aime consommer local!<br>Alors vous aussi, faites vous plaisir dans vos commerces de proximité et restez au courant de leurs actualités grâce à Gling.<br>Et… N’oubliez pas de rester sage!</p></div></div><div class=publication-block><div class=\"see-more link\" ng-click=\"goTo('/')\">Voir plus...</div><div class=block-title>Les dernières actualités de vos commerces</div><publication-list-ctrl ng-info=publicationListCtrl></publication-list-ctrl><div class=\"link center\" ng-click=\"goTo('/')\">Découvrez plus d'actualités...</div></div></div><div class=right-column><div class=facebook-block><div class=block-title>Participez sur notre page Facebook!</div><div class=fb-post data-width=370 data-href=https://www.facebook.com/gling.be/posts/1695721087310165></div></div><div class=map-block><div class=\"see-more link\" ng-click=\"goTo('/map/')\">Voir plus...</div><div class=block-title>Les quartiers actifs</div><img src=/assets/images/map/1160.png ng-click=\"goTo('/map',{x:50.815060,y:4.425933})\"></div><div class=last-business-block><div class=block-title>Connaissez-vous ?</div><div class=welcome-business-list><div class=welcome-business-list-el ng-repeat=\"business in businesses\"><table><tr><td ng-click=\"goTo('/business/'+business.id)\" rowspan=2><img class=illustration ng-src=\"{{business.illustration | image}}\"></td><td ng-click=\"goTo('/business/'+business.id)\"><div class=title>{{business.name}}</div></td></tr><tr><td><div class=address>{{business.address.street}}, {{business.address.zip}} {{business.address.city}} - {{business.distance / 1000 | number:2}} km<br></div></td></tr></table><category-line-ctrl ng-info={categories:business.categories,level1:false}></category-line-ctrl><follow-widget-ctrl ng-info={displayText:true,business:business}></follow-widget-ctrl></div></div></div></div></div></div></div>");
}]);
